...
func (d *Driver) SetConfigFromFlags(flags drivers.DriverOptions) error {
	d.SSHUser = "docker"
	d.SSHPort = 22
	d.CPU = flags.Int("vsphere-cpu-count")
	d.Memory = flags.Int("vsphere-memory-size")
	d.DiskSize = flags.Int("vsphere-disk-size")
	d.Boot2DockerURL = flags.String("vsphere-boot2docker-url")
	d.IP = flags.String("vsphere-vcenter")
	d.Port = flags.Int("vsphere-vcenter-port")
	d.Username = flags.String("vsphere-username")
	d.Password = flags.String("vsphere-password")
	d.Networks = flags.StringSlice("vsphere-network")
	d.Datastore = flags.String("vsphere-datastore")
	d.Datacenter = flags.String("vsphere-datacenter")
	// Sanitize input on ingress.
	d.Folder = strings.Trim(flags.String("vsphere-folder"), "/")
	d.Pool = flags.String("vsphere-pool")
	d.HostSystem = flags.String("vsphere-hostsystem")
	d.CfgParams = flags.StringSlice("vsphere-cfgparam")
	d.CloudInit = flags.String("vsphere-cloudinit")
...
func (d *Driver) PreCreateCheck() error {
	...
	log.Info("Custom build - Rancher Labs")
	// Create context
	ctx, cancel := context.WithCancel(context.Background())
	defer cancel()
